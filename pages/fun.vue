      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <div class="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
              I have a passion for the game industry and have used Unity in the
              past to spin up small games and prototypes. Additionally, I've
              been fascinated with XR these last few years.
            </p>
          </div>
