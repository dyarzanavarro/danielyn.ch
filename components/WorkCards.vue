          ...
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <p class="text-base leading-4 text-gray-500 dark:text-gray-200">{{ project.date }}</p>
                <p class="text-base leading-none text-gray-500 ml-12 dark:text-gray-200">{{ project.readTime }}</p>
              </div>
            </div>
            <h1 class="text-2xl font-semibold leading-6 my-4 text-gray-800 dark:text-gray-100">{{ project.title }}</h1>
            <p class="text-base leading-6 text-gray-700 dark:text-gray-200 mt-2 dark:text-gray-300">{{ project.description }}</p>
          </div>
        </div>
      </nuxt-link>
    </SwiperSlide>
