<template>
  <div class="2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4 absolute top-0 left-0 right-0 z-50">    <!-- For large and Medium-sized Screen -->
    <div class="flex justify-between">
      ...
      <div
        class="mt-4 mx-auto flex justify-center items-center sm:hidden cursor-pointer absolute right-16 top-0 m-4"
      >
        <button @click="toggle">
          <img
            v-if="$colorMode.value == 'dark'"
      ...
      <div
        id="bgIcon"
        @click="toggleMenu()"
        class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 dark:ring-gray-800 flex justify-center items-center sm:hidden cursor-pointer absolute right-0 top-0 m-4"
      >
        <img
          v-if="$colorMode.value == 'dark'"
          class="h-8 object-bottom hover:animate-pulse cursor-pointer my-3"
        ...
        <img
          v-if="$colorMode.value == 'dark'"
          class="hidden h-8 object-bottom hover:animate-pulse cursor-pointer my-3"
